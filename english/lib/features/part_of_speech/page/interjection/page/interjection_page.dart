import 'package:english/features/part_of_speech/page/interjection/data/interjection_data.dart';
...
class InterjectionPage extends StatefulWidget {
  const InterjectionPage({super.key});

  @override
  State<InterjectionPage> createState() => InterjectionPageState();
}

class InterjectionPageState extends State<InterjectionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: kindsOfInterjection.length,
        itemBuilder: (context, index) {
          final verb = kindsOfInterjection[index];
          final length = kindsOfInterjection.length;
          return Card(
                ...
                children: [
                  ...
                  if (index == length - 1)
                    Row(
                      ...
                      children: [
                        NextButton(onTap: () {
                          Navigator.pushNamed(context, RoutesName.sentencePage);
                        }),
                      ],
                    )
                ],
