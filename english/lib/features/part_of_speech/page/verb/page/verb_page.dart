...
class _VerbPageState extends State<VerbPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:CustomAppBar(title: "Verb"),
      body: ListView.builder(
        itemCount: kindsOfVerb.length,
        itemBuilder: (context, index) {
          final verb = kindsOfVerb[index];
          final length = kindsOfVerb.length;
          return Card(
                ...
                children: [
                  ...
                  if (index == length - 1)
                    Row(
                      ...
                      children: [
                        NextButton(onTap: () {
                          Navigator.pushNamed(context, RoutesName.transitiveVerbPage);
                        }),
                      ],
                    )
                ],
