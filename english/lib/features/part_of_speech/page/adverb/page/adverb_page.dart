...
import '../data/adverb_data.dart';

class AdverbPage extends StatefulWidget {
  const AdverbPage({super.key});

  @override
  State<AdverbPage> createState() => AdverbPageState();
}

class AdverbPageState extends State<AdverbPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: kindsOfAdverb.length,
        itemBuilder: (context, index) {
          final verb = kindsOfAdverb[index];
          final length = kindsOfAdverb.length;
          return Card(
                ...
                children: [
                  ...
                  if (index == length - 1)
                    Row(
                      ...
                      children: [
                        NextButton(onTap: () {
                          Navigator.pushNamed(context, RoutesName.articlePage);
                        }),
                      ],
                    )
                ],
